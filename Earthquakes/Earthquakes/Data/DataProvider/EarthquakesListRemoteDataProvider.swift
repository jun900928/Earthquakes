//
//  EarthquakesRemoteDataProvider.swift
//  Earthquakes
//
...
class EarthquakesListRemoteDataProvider {
    var response: EarthquakesResponse?
    var config: QueryConfig?
    var isRefreshing = false
}

extension EarthquakesListRemoteDataProvider: RemoteDataProvider{
...
extension EarthquakesListRemoteDataProvider
{
